...
const Header = () => {
  ...
  return (
    <div className="fixed top-8 left-0 right-0 z-50 px-6 pointer-events-none">
      <nav className="max-w-4xl mx-auto bg-white/80 backdrop-blur-xl rounded-full border-4 border-white bubbly-card-white pointer-events-auto flex items-center justify-between px-8 py-3 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.1)]">
...
const Hero = () => {
  ...
  return (
    <section 
      id="home" 
      className="pt-36 pb-24 px-12 relative overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center relative z-10">
        <motion.div 
        ...
        >
          ...
          <div className="space-y-4">
            <h1 className="text-5xl lg:text-6xl font-display font-black text-brand-primary leading-[1.1] tracking-tight">
              Every Big Dream <br/>
              Starts with <br/>
              <span className="text-brand-sky italic font-hand transform inline-block -rotate-2 ml-1">Tiny</span> Toes<span className="text-brand-soft-peach">.</span>
            </h1>
          </div>
          <div className="space-y-4">
            <p className="text-base text-brand-dove-gray leading-relaxed max-w-md font-medium opacity-80">
          ...
          <div className="flex flex-wrap gap-6 pt-4">
            <button className="soft-bubbly-white px-10 py-5 text-xs uppercase tracking-widest">
              Explore Programs
            </button>
            <button className="soft-bubbly-peach px-10 py-5 text-xs uppercase tracking-widest">
              Enroll Your Child
            </button>
            <button className="soft-bubbly-white px-10 py-5 text-xs uppercase tracking-widest flex items-center gap-3">
        ...
        <motion.div 
          ...
          className="md:col-span-12 lg:col-span-5 relative flex items-center justify-center p-10 group/cutout"
        ...
        >
           ...
           >
             <img 
               src="https://i.postimg.cc/g0S5GMwp/Group-9.png" 
               alt="Happy Children Playing" 
               className="w-full h-auto drop-shadow-[0_40px_80px_rgba(0,0,0,0.15)] group-hover/cutout:drop-shadow-[0_60px_100px_rgba(0,0,0,0.25)] transition-all duration-500 scale-110 lg:scale-[1.4]"
               referrerPolicy="no-referrer"
             />
           ...
           <motion.div 
             ...
             className="absolute -top-10 right-10 text-[#0284c7] embossed-icon"
           >
...
const SlidingRibbon = () => {
  ...
  return (
    <div className="bg-[#1A252F] text-white py-6 overflow-hidden italic font-black text-xl relative border-y border-white/5">
...
const Stats = () => {
  return (
    <section className="px-12 py-12 grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto relative z-10">
      <div className="bubbly-card-sky p-8 text-center flex flex-col items-center justify-center space-y-3">
        <div className="text-brand-sky font-black text-5xl font-display drop-shadow-2xl">1000+</div>
        <div className="text-brand-primary font-black text-[10px] uppercase tracking-[0.2em] opacity-60">Happy Graduates</div>
      </div>
      <div className="bubbly-card-yellow p-8 text-center flex flex-col items-center justify-center space-y-3">
        <div className="text-brand-primary font-black text-2xl font-display drop-shadow-2xl leading-none">India’s 1st</div>
        <div className="text-brand-sky font-black text-[10px] uppercase tracking-[0.2em] leading-tight opacity-60">Entrepreneurial Preschool</div>
      </div>
      <div className="bubbly-card-mint p-8 text-center flex flex-col items-center justify-center space-y-3">
        <div className="text-brand-mint font-black text-5xl font-display drop-shadow-2xl" style={{ color: '#48C9B0' }}>98%</div>
        <div className="text-brand-primary font-black text-[10px] uppercase tracking-[0.2em] opacity-60">Parent Satisfaction</div>
      </div>
    </section>
  );
};
...
const WhyChooseTimeline = () => {
  ...
  return (
    <section id="why-choose" className="py-24 px-6 lg:px-12 bg-[#F8FBFF] relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-12">
            <div className="space-y-6">
              ...
              <p className="text-base text-brand-dove-gray font-medium max-w-xl leading-relaxed opacity-80">
              ...
              {steps.map((s, i) => (
                ...
                >
                  ...
                  <div className="space-y-1 pt-1">
                    ...
                    <p className="text-brand-dove-gray font-medium text-sm leading-relaxed max-w-sm opacity-80">{s.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
          ...
          <div className="relative hidden lg:block h-[700px] w-full">
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-4/5 aspect-[4/5] bg-white p-4 pb-16 shadow-[0_50px_120px_-20px_rgba(0,0,0,0.2)] rounded-sm rotate-[-1deg] z-40"
            >
              <img 
            ...
            <motion.div 
              ...
              className="absolute top-[-5%] right-[-10%] w-3/5 aspect-square bg-white p-3 pb-12 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] rounded-sm rotate-[12deg] z-10 group"
            >
              <img 
            ...
            <motion.div 
              ...
              className="absolute bottom-[-5%] left-[-10%] w-1/2 aspect-square bg-white p-3 pb-10 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.1)] rounded-sm rotate-[-10deg] z-10 group"
            >
              <img 
...
const Programs = () => {
  ...
  return (
    <section id="programs-grid" className="py-16 px-6 lg:px-12 bg-[#ECF5FF] overflow-hidden relative">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12 space-y-4">
           <h2 className="text-4xl lg:text-5xl font-display font-black text-brand-primary tracking-tight leading-tight drop-shadow-sm">Our Programs</h2>
           <p className="text-base text-brand-dove-gray font-medium max-w-lg mx-auto opacity-70 italic font-display">
            ...
            <AnimatePresence mode="popLayout" initial={false}>
              {programs.map((p, i) => {
                ...
                if (isCenter) {
                  ...
                  x = "-55%"; // Adjusted for smaller containers
                  scale = 0.8;
                  zIndex = 10;
                  opacity = 0.5;
                  rotateY = 25; 
                ...
                return (
                  <motion.div 
                    ...
                    whileHover="hover"
                    className={`absolute w-full max-w-[400px] bg-white rounded-[40px] overflow-hidden border-[6px] ${p.color} ${isCenter ? 'shadow-[0_40px_80px_-20px_rgba(0,0,0,0.2)]' : 'shadow-[0_15px_30px_-10px_rgba(0,0,0,0.1)]'} flex flex-col cursor-pointer transition-shadow group`}
                    onClick={() => {
                      if (!isCenter) {
                        setActiveIndex(i);
                        playSwish();
                  ...
                  >
                    ...
                    <div className="px-7 pb-7 pt-5 flex-grow space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <p className="text-brand-dove-gray font-medium text-xs leading-relaxed opacity-80">{p.desc}</p>
                      </div>
    ...
    <section id="gallery" className="py-16 bg-white overflow-hidden relative">
      <div className="max-w-4xl mx-auto px-6 lg:px-12 mb-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-base text-brand-dove-gray font-medium max-w-lg mx-auto opacity-80">A scrapbook of smiles, laughter, and school life</p>
        </div>
      </div>
      ...
      <div className="relative">
        <motion.div 
          animate={{
            x: [0, -3360], // (320px width + 16px gap) * 10 images
          }}
          transition={{
            duration: 35,
            repeat: Infinity,
        ...
        >
          {duplicatedImages.map((img, i) => (
            <motion.div 
              key={i} 
              className="flex-shrink-0 w-[240px] md:w-[320px] h-[300px] md:h-[400px] rounded-[40px] overflow-hidden shadow-[0_24px_48px_-12px_rgba(0,0,0,0.12)] border-6 border-white bubbly-card-white"
...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-24 px-12 bg-[#F8FBFF] relative overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20 space-y-4">
           ...
           <p className="max-w-2xl mx-auto text-base text-brand-dove-gray font-medium leading-relaxed opacity-80 italic mt-6">Nothing makes us prouder than hearing how Junior Toes Indiranagar changed a child's confidence, curiosity, and love for learning.</p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          {/* Summary Card */}
          <div className="lg:col-span-4 bg-white rounded-[48px] p-10 shadow-[0_32px_64px_-24px_rgba(0,0,0,0.15)] border-4 border-white bubbly-card-white lg:sticky lg:top-32">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 md:grid-cols-2 gap-8">
            {reviews.map((review, i) => (
              <motion.div 
                ...
                transition={{ delay: i * 0.1 }}
                whileHover={{ y: -10 }}
                className={`bg-white p-10 rounded-[48px] shadow-[0_24px_48px_-12px_rgba(0,0,0,0.1)] border-4 border-white hover:shadow-[0_32px_64px_-16px_rgba(0,0,0,0.15)] transition-all duration-500 group cursor-default`}
              >
	...
	c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"></path></svg>
                ...
                <div className="space-y-6">
                  <p className="text-brand-dove-gray text-base leading-relaxed font-medium italic opacity-90">
                    "{review.text}"
                  </p>
...
const Mentors = () => {
  const mentors = [
    { 
      ...
      image: "https://www.juniortoes.com/static/media/sunitha.7d9a704153a9e9d1b56b.jpg",
    ...
    { 
      ...
      institution: "Junior Toes",
      image: "https://www.juniortoes.com/static/media/ashwiniimg.54d4d245a4bdeb26ecd4.png",
      accent: "bg-brand-sky"
    },
    { 
      ...
      role: "Co-Founder & CEO",
      institution: "Junior Toes",
      image: "https://www.juniortoes.com/static/media/spoorthiblack.dc6867b82dc054ade444.jpeg",
    ...
    { 
      ...
      image: "https://www.juniortoes.com/static/media/stella.937acc0e3f8adcb5ec1b.png",
    ...
    { 
      ...
      role: "Director",
      institution: "Junior Toes",
      image: "https://www.juniortoes.com/static/media/shruthiblack.2faeec24b3b0644f0e9d.jpeg",
      accent: "bg-[#D4E6F1]"
    },
  ];

  return (
    <section id="mentors" className="pt-32 pb-16 px-12 bg-[#FDFDFD] relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="text-center mb-24 space-y-4">
           ...
           <h2 className="text-5xl lg:text-6xl font-display font-black text-brand-primary tracking-tight leading-tight">Loving Mentors</h2>
           <p className="max-w-2xl mx-auto text-lg text-brand-dove-gray font-medium leading-relaxed opacity-70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8">
          {mentors.map((m, i) => (
            ...
            >
               ...
               <div className="relative aspect-[4/5] rounded-[48px] overflow-hidden mb-8 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.1)] transition-all duration-500 group-hover:shadow-[0_30px_60px_-20px_rgba(0,0,0,0.15)]">
                  <img 
                    src={m.image} 
                    alt={m.name} 
               ...
               <div className="space-y-2 px-4 transition-transform duration-500 group-hover:translate-x-1">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-medium text-brand-dove-gray uppercase tracking-[0.1em] opacity-50">
                      {m.institution}
                    </p>
                  </div>
               </div>
...
const BrandPlaybook = () => {
  ...
  return (
    <section id="brand-playbook" className="py-32 px-6 lg:px-12 bg-[#F9FBFF] relative overflow-hidden">
      {/* Subtle Grid Pattern */}
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20 space-y-4">
           ...
           <p className="max-w-2xl mx-auto text-base text-brand-dove-gray font-medium leading-relaxed opacity-70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-16 items-start">
          {cards.map((card, i) => (
            ...
            >
              ...
              {/* Polaroid Card */}
              <div className="bg-white p-6 pb-12 shadow-[0_20px_50px_rgba(0,0,0,0.06)] border border-brand-offwhite rounded-sm transform transition-all duration-500 group-hover:shadow-[0_40px_80px_rgba(0,0,0,0.12)] group-hover:-translate-y-2">
                ...
                <div className="space-y-4 px-2">
                  ...
                  <p className="text-sm text-brand-dove-gray font-medium leading-relaxed opacity-80">
                    {card.description}
                  </p>
...
const SocialReels = () => {
  ...
  return (
    <section id="social-reels" className="py-32 px-6 lg:px-12 bg-[#F9FBFF] relative overflow-hidden">
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-20 space-y-4">
           ...
           <p className="max-w-xl mx-auto text-base text-brand-dove-gray font-medium leading-relaxed opacity-70">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {reels.map((id, i) => (
            ...
            >
              ...
              <div className="bg-white rounded-[32px] overflow-hidden p-2 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-brand-offwhite group-hover:shadow-[0_20px_50px_rgba(0,0,0,0.08)] transition-all duration-500">
              ...
              <div className="mt-4 flex items-center justify-between px-2">
                 <div className="flex items-center gap-2">
                    ...
                    <span className="text-[9px] font-bold text-brand-dove-gray uppercase tracking-widest opacity-60">Reel Clip</span>
                 </div>
...
const Footer = () => {
  return (
    <footer id="locations" className="bg-brand-primary text-white pt-24 pb-12 px-6 lg:px-12 relative overflow-hidden">
      {/* Background decoration */}
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24 mb-24">
          ...
          <div className="lg:col-span-4 space-y-10">
            <div className="space-y-6">
              <div className="bg-white p-4 rounded-3xl inline-flex items-center justify-center shadow-xl border-4 border-brand-sky/10 transform -rotate-1">
                <img 
                  src="https://i.postimg.cc/L52b2JkV/Main-JT-logo.png" 
                  alt="Junior Toes Logo" 
              ...
              <p className="text-brand-dove-gray text-base leading-relaxed max-w-sm font-medium italic opacity-70">
            ...
            <div className="flex gap-3">
              {[
                ...
                <a 
                  ...
                  rel="noopener noreferrer" 
                  aria-label={s.label}
                  className="w-11 h-11 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center text-white hover:bg-brand-sky hover:border-brand-sky hover:-translate-y-1 transition-all duration-300"
                >
                  {s.icon}
                </a>
              ))}
          ...
          <div className="lg:col-span-4 grid grid-cols-2 gap-8">
            <div className="space-y-8">
              ...
              <ul className="space-y-4 font-bold text-sm text-brand-dove-gray">
          ...
          <div className="lg:col-span-4 space-y-12">
            <div className="space-y-6">
              ...
              <div className="flex gap-4 group">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-brand-dove-gray leading-relaxed font-medium max-w-[220px]">
            ...
            <div className="space-y-6 pt-8 border-t border-white/5">
              <div className="flex justify-between items-center bg-white/5 p-4 rounded-2xl border border-white/5 hover:border-brand-sky/20 transition-colors">
                <div className="flex items-center gap-3">
                   <div className="w-2 h-2 rounded-full bg-brand-sky animate-pulse" />
                   <span className="text-xs font-bold text-brand-dove-gray">Mon - Fri Doors Open</span>
                </div>
                <span className="text-xs font-black">9:00 - 18:00</span>
              </div>
        ...
        {/* Sub-footer */}
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-brand-dove-gray">
...
export default function App() {
  return (
    <div className="min-h-screen bg-brand-offwhite selection:bg-brand-sky/30">
      <CustomCursor />
      <Header />
      <Hero />
      <SlidingRibbon />
